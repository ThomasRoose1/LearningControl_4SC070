###########################################################################
## Makefile generated for component 'Arizona_base_GOAT'. 
## 
## Makefile     : Arizona_base_GOAT.mk
## Generated on : Fri May 22 15:33:37 2026
## Final product: $(START_DIR)/Arizona_base_GOAT_slrealtime_rtw/Arizona_base_GOAT
...
PRODUCT_NAME              = Arizona_base_GOAT
MAKEFILE                  = Arizona_base_GOAT.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/Arizona_PC/Desktop/Arizona/Arizona_Gijs_22_05/Runfiles
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C++
...
PRODUCT = $(START_DIR)/Arizona_base_GOAT_slrealtime_rtw/Arizona_base_GOAT
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Arizona_base_GOAT_slrealtime_rtw -I$(MATLAB_ROOT)/toolbox/slrealtime/simulink/blocks/dist/include -I$(MATLAB_ROOT)/toolbox/slrealtime/target/kernel/dist/include -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2022a/941~1.1_2/SG_BLO~1/common/libsg -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2022a/941~1.1_2 -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2022a/941~1.1_2/SG_BLO~1/analog/include -IC:/PROGRA~3/SPEEDG~1/SPEEDG~1/R2022a/941~1.1_2/SG_BLO~1/fpga/setup/include -I$(START_DIR)/Arizona_base_GOAT_slrealtime_rtw/instrumented
...
DEFINES_STANDARD = -DMODEL=Arizona_base_GOAT -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
%.o : $(START_DIR)/Arizona_base_GOAT_slrealtime_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/Arizona_base_GOAT_slrealtime_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/Arizona_base_GOAT_slrealtime_rtw/instrumented/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/Arizona_base_GOAT_slrealtime_rtw/instrumented/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
...
Arizona_base_GOAT.o : $(START_DIR)/Arizona_base_GOAT_slrealtime_rtw/Arizona_base_GOAT.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


Arizona_base_GOAT_cal.o : $(START_DIR)/Arizona_base_GOAT_slrealtime_rtw/Arizona_base_GOAT_cal.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetInf.o : $(START_DIR)/Arizona_base_GOAT_slrealtime_rtw/rtGetInf.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rtGetNaN.o : $(START_DIR)/Arizona_base_GOAT_slrealtime_rtw/rtGetNaN.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rt_nonfinite.o : $(START_DIR)/Arizona_base_GOAT_slrealtime_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


slrealtime_datatype_ground.o : $(START_DIR)/Arizona_base_GOAT_slrealtime_rtw/slrealtime_datatype_ground.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


rte_Arizona_base_GOAT_parameters.o : $(START_DIR)/Arizona_base_GOAT_slrealtime_rtw/rte_Arizona_base_GOAT_parameters.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


main.o : $(START_DIR)/Arizona_base_GOAT_slrealtime_rtw/main.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


dlowpass2.o : C:/Users/Arizona_PC/Documents/MATLAB/Shapeit_student_version_v0.16/dlowpass2.c
	$(CC) $(CFLAGS) -o $@ $<
