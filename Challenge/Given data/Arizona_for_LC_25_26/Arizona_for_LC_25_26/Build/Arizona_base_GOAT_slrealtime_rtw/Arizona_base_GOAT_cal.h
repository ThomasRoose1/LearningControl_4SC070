...
struct Arizona_base_GOAT_cal_type {
  ...
  real_T phiFF_Y0;                     /* Computed Parameter: phiFF_Y0
                                        ...
                                        */
  real_T set_phiFF_Value[4194];        /* Expression: zeros(Nref,1)
                                        * Referenced by: '<S3>/set_phiFF'
                                        */
  real_T set_xFF_Value[4194];          /* Expression: zeros(Nref,1)
                                        * Referenced by: '<S3>/set_xFF'
                                        */
  real_T set_yFF_Value[4194];          /* Expression: zeros(Nref,1)
  ...
  real_T Constant_Value_e;             /* Expression: 1
                                        ...
                                        */
  real_T set_yRef_Value[4194];         /* Expression: zeros(Nref,1)
                                        * Referenced by: '<S11>/set_yRef'
                                        */
  real_T set_cRef_Value[4194];         /* Expression: zeros(Nref,1)
                                        * Referenced by: '<S11>/set_cRef'
                                        */
  real_T set_phiRef_Value[4194];       /* Expression: zeros(Nref,1)
                                        * Referenced by: '<S11>/set_phiRef'
                                        */
  real_T set_xRef_Value[4194];         /* Expression: zeros(Nref,1)
