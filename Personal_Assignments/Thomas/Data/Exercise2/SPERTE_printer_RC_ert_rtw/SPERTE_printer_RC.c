 ...
 * C source code generated on : Wed May 13 12:04:26 2026
 *
...
void SPERTE_printer_RC_step(void)
{
  ...
  if (SPERTE_printer_RC_B.Product > 0) {
    ...
    SPERTE_printer_RC_DW.Delay_DSTATE[2] = rtb_Internal;
    ...
    SPERTE_printer_RC_DW.Delay1_DSTATE[1754] = rtb_Sum2 + rtb_Delay;
    ...
    /* Update for DiscreteStateSpace: '<S23>/Internal' */
    {
      ...
      xnew[7] = (SPERTE_printer_RC_P.Internal_A_f[19])*
...
void SPERTE_printer_RC_initialize(void)
{
  ...
  /* External mode info */
  SPERTE_printer_RC_M->Sizes.checksums[0] = (400135577U);
  SPERTE_printer_RC_M->Sizes.checksums[1] = (502057321U);
  SPERTE_printer_RC_M->Sizes.checksums[2] = (286802829U);
  SPERTE_printer_RC_M->Sizes.checksums[3] = (2013307741U);
