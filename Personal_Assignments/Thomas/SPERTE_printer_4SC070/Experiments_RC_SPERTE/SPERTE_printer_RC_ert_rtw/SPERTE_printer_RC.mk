###########################################################################
## Makefile generated for component 'SPERTE_printer_RC'. 
## 
## Makefile     : SPERTE_printer_RC.mk
## Generated on : Wed Apr 29 16:55:59 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SPERTE_printer_RC.elf
...
PRODUCT_NAME              = SPERTE_printer_RC
MAKEFILE                  = SPERTE_printer_RC.mk
...
START_DIR                 = $(MATLAB_WORKSPACE)/C/git/LearningControl_4SC070/Personal_Assignments/Thomas/SPERTE_printer_4SC070/Experiments_RC_SPERTE
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = GNU
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SPERTE_printer_RC.elf
...
OBJS = xcp_ext_mode.c.o rt_matrx.c.o rt_printf.c.o SPERTE_printer_RC.c.o SPERTE_printer_RC_data.c.o rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o rt_zcfcn.c.o MW_custom_RTOS.c.o xcp_ext_common.c.o xcp_ext_classic_trigger.c.o xcp.c.o xcp_standard.c.o xcp_daq.c.o xcp_calibration.c.o xcp_fifo.c.o xcp_transport.c.o xcp_mem_default.c.o xcp_drv_rtiostream.c.o xcp_utils.c.o xcp_frame_tcp.c.o xcp_ext_param_default_tcp.c.o dlowpass2.c.o dpd.c.o dweakint_resettable.c.o ec_Ebox.c.o ec_EboxResetEnc.c.o ec_Supervisor.c.o MW_raspi_init.c.o MW_Pyserver_control.c.o linuxTimeLogger.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o rtiostream_utils.c.o xcp_platform_default.c.o
...
%.c.o : $(MATLAB_WORKSPACE)/C/Users/thoma/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(MATLAB_WORKSPACE)/C/Users/thoma/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(MATLAB_WORKSPACE)/C/Users/thoma/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.c.o : $(START_DIR)/SPERTE_printer_RC_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/SPERTE_printer_RC_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/SPERTE_printer_RC_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.c.o : $(MATLAB_WORKSPACE)/C/Users/thoma/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/target/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(MATLAB_WORKSPACE)/C/Users/thoma/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/target/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(MATLAB_WORKSPACE)/C/Users/thoma/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/target/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/SPERTE_printer_RC_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SPERTE_printer_RC.c.o : $(START_DIR)/SPERTE_printer_RC_ert_rtw/SPERTE_printer_RC.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SPERTE_printer_RC_data.c.o : $(START_DIR)/SPERTE_printer_RC_ert_rtw/SPERTE_printer_RC_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/SPERTE_printer_RC_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/SPERTE_printer_RC_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/SPERTE_printer_RC_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_zcfcn.c.o : $(START_DIR)/SPERTE_printer_RC_ert_rtw/rt_zcfcn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MW_custom_RTOS.c.o : $(MATLAB_WORKSPACE)/C/Users/thoma/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/target/MW_custom_RTOS.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
dlowpass2.c.o : $(MATLAB_WORKSPACE)/C/Users/thoma/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dlowpass2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dpd.c.o : $(MATLAB_WORKSPACE)/C/Users/thoma/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dpd.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dweakint_resettable.c.o : $(MATLAB_WORKSPACE)/C/Users/thoma/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dweakint_resettable.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ec_Ebox.c.o : $(MATLAB_WORKSPACE)/C/Users/thoma/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/ec_Ebox.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ec_EboxResetEnc.c.o : $(MATLAB_WORKSPACE)/C/Users/thoma/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/ec_EboxResetEnc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ec_Supervisor.c.o : $(MATLAB_WORKSPACE)/C/Users/thoma/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/ec_Supervisor.c
	$(CC) $(CFLAGS) -o "$@" "$<"
