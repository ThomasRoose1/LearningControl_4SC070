...
PRODUCT_NAME              = SPERTE_printer
MAKEFILE                  = SPERTE_printer.mk
MATLAB_ROOT               = $(MATLAB_WORKSPACE)/C/Program_Files/MATLAB
MATLAB_BIN                = $(MATLAB_WORKSPACE)/C/Program_Files/MATLAB/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = $(MATLAB_WORKSPACE)/C/Users/marie/OneDrive/Documenten/GitHub/LearningControl_4SC070/Personal_Assignments/Lars/SPERTE_printer_4SC070/Experiments_ILC_SPERTE
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SPERTE_printer.elf
...
%.c.o : $(MATLAB_WORKSPACE)/C/Users/marie/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(MATLAB_WORKSPACE)/C/Users/marie/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(MATLAB_WORKSPACE)/C/Users/marie/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.c.o : $(START_DIR)/SPERTE_printer_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/SPERTE_printer_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/SPERTE_printer_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/SPERTE_printer_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SPERTE_printer.c.o : $(START_DIR)/SPERTE_printer_ert_rtw/SPERTE_printer.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SPERTE_printer_data.c.o : $(START_DIR)/SPERTE_printer_ert_rtw/SPERTE_printer_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/SPERTE_printer_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/SPERTE_printer_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/SPERTE_printer_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_zcfcn.c.o : $(START_DIR)/SPERTE_printer_ert_rtw/rt_zcfcn.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
dlowpass2.c.o : $(MATLAB_WORKSPACE)/C/Users/marie/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dlowpass2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dpd.c.o : $(MATLAB_WORKSPACE)/C/Users/marie/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dpd.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dweakint_resettable.c.o : $(MATLAB_WORKSPACE)/C/Users/marie/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dweakint_resettable.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ec_Ebox.c.o : $(MATLAB_WORKSPACE)/C/Users/marie/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/ec_Ebox.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ec_EboxResetEnc.c.o : $(MATLAB_WORKSPACE)/C/Users/marie/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/ec_EboxResetEnc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ec_Supervisor.c.o : $(MATLAB_WORKSPACE)/C/Users/marie/AppData/Roaming/MathWorks/MATLAB_Add-Ons/Toolboxes/SPERTE/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/ec_Supervisor.c
	$(CC) $(CFLAGS) -o "$@" "$<"
